    ...
    <div className="homepage">
        ...
        <div className="container">
			<blockquote class="blockquote text-center">
  				<p class="mt-5">ಎಮ್.ಎಮ್.ಜಿ.ಎಸ್ ಸಂಸ್ಥೆಯ ನೇತೃತ್ವದಲ್ಲಿ ನಡೆಯುತ್ತಿರುವ "ರೈತಮಿತ್ರ" ಕಾರ್ಯಕ್ರಮಕ್ಕೆ ಕರ್ನಾಟಕದ ಹಲವಾರು ಸಂಘಸಂಸ್ಥೆಗಳು, ಎನ್.ಜಿ.ಓ, ರಸಗೊಬ್ಬರ ಮಾರಾಟಗಾರರು, ಕಂಪನಿಗಳು ಹಾಗೂ ದಾನಿಗಳ ಸಹಯೋಗದೊಂದಿಗೆ 5 ಎಕರೆಗಿಂತ ಕಡಿಮೆ ಭೂಮಿ, ಹಿಂದುಳಿದ ವರ್ಗ, ಬಡ ರೈತ ಕುಟುಂಬಗಳಿಗೆ ನೆರವಾಗುವ ನಿಟ್ಟಿನಲ್ಲಿ ರಸಗೊಬ್ಬರಗಳು, ಬಿತ್ತನೇ ಬೀಜ, ಕೀಟನಾಷಕಗಳನ್ನು ಅತಿ ಕಡಿಮೇ ದರದಲ್ಲಿ ವಿತರಿಸುವ ಒಂದು ಪ್ರಯತ್ನವಾಗಿದೆ. ಹೆಚ್ಚು ಹೆಚ್ಚು ರೈತರು ಇದರ ಉಪಯೋಗ ಪಡೆಯಬೇಕೆಂದು ಆಶಿಸುತ್ತೇವೆ.</p>
			</blockquote>
